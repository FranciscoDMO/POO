...
{  
   ...
   // double locationY, double custoKM, double raio , int nif , double aval , double numrev
    ...
    public double KmsPercurridos(Transportadora e){
        ...
        for(Encomenda a : this.Encomendas.values()){
            ...
            User b=  users.get(a.getBuyer());
            User l=  users.get(a.getLoja()); 
    ...
    public ArrayList<Encomenda> EncomendasParaVoluntarioDentroRaio(String codVol){
        ...
        double transtoloja = Math.sqrt(Math.pow(v.locationX - l.getLocationX(), 2) +
                     Math.pow(v.locationY - l.getLocationY(), 2));
        double transtobuyer =Math.sqrt(Math.pow(v.locationX - b.getLocationX(), 2) +
                     Math.pow(v.locationY - b.getLocationY(), 2));
    ...
    public void top10Empresas (){
        ...
        return Double.compare(this.KmsPercurridos(emp2), this.KmsPercurridos(emp1)); };
    ...
    public double getNumencomendas(Buyer b){
        double i =0;
        for(Encomenda a : this.Encomendas.values()){
           if(b.getCodigo().equals(a.getBuyer())){
              i=i+1;
        }
      }
       return i ; 
   ...
   //top 10 users que mais encomendas fizeram 
    public void top10Users(){
        ...
        return Double.compare(getNumencomendas(emp2), getNumencomendas(emp1)); };
        for ( User a : users.values()){
